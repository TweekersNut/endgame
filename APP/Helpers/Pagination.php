...
class Pagination
{
    ...
    protected $previousText = 'fa fa-arrow-left';
    protected $nextText = 'fa fa-arrow-right';
    ...
    public function toHtml()
    {
        ...
        if ($this->getPrevUrl()) {
            $html .= '<li><a href="' . htmlspecialchars($this->getPrevUrl()) . '"><i class=" '. $this->previousText .'"></i></a></li>';
        }
        ...
        if ($this->getNextUrl()) {
            $html .= '<li><a href="' . htmlspecialchars($this->getNextUrl()) . '"><i class="page-item '. $this->nextText .'"></i></a></li>';
        }
        $html .= '</ul>';
    ...
    public function toHtmlAdmin()
    {
        ...
        $html = '<ul class="pagination">';
        if ($this->getPrevUrl()) {
            $html .= '<li><a class="page-link" href="' . htmlspecialchars($this->getPrevUrl()) . '"><i class="page-item '. $this->previousText .'"></i></a></li>';
        }
        ...
        if ($this->getNextUrl()) {
            $html .= '<li><a class="page-link" href="' . htmlspecialchars($this->getNextUrl()) . '"><i class="page-item '. $this->nextText .'"></i></a></li>';
        }
        $html .= '</ul>';
