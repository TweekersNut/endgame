...
<div class="outer-w3-agile mt-3 col-md-12">
    <h4 class="tittle-w3-agileits mb-4">Filter Data : <?= $data['filter_name'] ?></h4>
    <div class="row">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <select class="form-control-sm" name="filter">
                            <option value="1" <?php if($_POST['filter'] == 1){echo "selected";} ?>>I.D Ascending</option>
                            <option value="2" <?php if($_POST['filter'] == 2){echo "selected";} ?>>I.D Descending</option>
                            <option value="3" <?php if($_POST['filter'] == 3){echo "selected";} ?>>Email Ascending</option>
                            <option value="4" <?php if($_POST['filter'] == 4){echo "selected";} ?>>Email Descending</option>
                            <option value="5" <?php if($_POST['filter'] == 5){echo "selected";} ?>>Username Ascending</option>
                            <option value="6" <?php if($_POST['filter'] == 6){echo "selected";} ?>>Username Descending</option>
                            <option value="7" <?php if($_POST['filter'] == 7){echo "selected";} ?>>Active User</option>
                            <option value="8" <?php if($_POST['filter'] == 8){echo "selected";} ?>>In-Active User</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
