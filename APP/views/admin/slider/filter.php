...
<div class="outer-w3-agile mt-3 col-md-12">
    <h4 class="tittle-w3-agileits mb-4">Slider Filter : <?= $data['filter_name'] ?></h4>
    <div class="row">
            ...
            <form class="form-inline" method="post" action="<?= URL::baseURL('admin/slider/search/') ?>">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <a class="btn btn-warning btn-sm" href="<?= URL::baseURL('admin/slider') ?>">Reset Search</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <select class="form-control-sm" name='filter'>
                            <option <?php if($data['filter_name'] == 'Active Slider.'){echo "selected";} ?> value="1">Active Slider</option>
                            <option <?php if($data['filter_name'] == 'In-Active Slider.'){echo "selected";} ?> value="2">In-Active Slider</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
