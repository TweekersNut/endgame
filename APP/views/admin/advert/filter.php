...
<div class="outer-w3-agile mt-3 col-md-12">
    <h4 class="tittle-w3-agileits mb-4">Advert Filter Data : <?= $data['filter_name'] ?></h4>
    <div class="row">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <select class="form-control-sm" name='filter'>
                            <option <?php if($_POST['filter'] == 1){echo "selected";} ?> value="1">Active Advert</option>
                            <option <?php if($_POST['filter'] == 2){echo "selected";} ?> value="2">In-Active Advert</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
