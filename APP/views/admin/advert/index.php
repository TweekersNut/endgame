...
<div class="outer-w3-agile mt-3 col-md-12">
    <h4 class="tittle-w3-agileits mb-4">All Advert Data</h4>
    <div class="row">
                    ...
                    <?php foreach ($data['all_advert_data'] as $advertData): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <button type="button" class="btn btn-dark btn-sm" onclick="markAdvertActive(<?= $advertData->id ?>)">Mark Active</button>
                                <?php endif; ?>
