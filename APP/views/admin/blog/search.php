...
<div class="outer-w3-agile mt-3 col-md-12">
    <h4 class="tittle-w3-agileits mb-4">Search : <?= $data['search_query'] ?></h4>
    <div class="row">
        <div class="col-md-4 col-lg-4">
            <form class="form-inline" method="post" action="<?= URL::baseURL('admin/blog/search/') ?>">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <input class="form-control-sm mr-sm-2" type="search" name="query" value="<?= $data['search_query'] ?>" placeholder="Search" aria-label="Search" required="">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <button class="btn btn-info btn-sm" type="submit">Search</button>
                        <a class="btn btn-warning btn-sm" href="<?= URL::baseURL('admin/blog') ?>">Reset</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <select class="form-control-sm" name='filter'>
                            <option <?php if($_POST['filter'] == 1){echo "selected";} ?> value="1">Published Posts</option>
                            <option <?php if($_POST['filter'] == 2){echo "selected";} ?> value="2">Draft Posts</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
